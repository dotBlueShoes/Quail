...
namespace WINDOWS::REGISTRY {
	...
	const c16 VALUE_UNINSTALL_DISPLAY_VERSION[]		= L"0";
	...
	void CreateKeys (const u32& filepathLength, const c16* const& filepath) {
		...
		{ // Uninstaller Key
			...
			CreatePropertyC16 (key, error, PROPERTY_UNINSTALL_DISPLAY_VERSION, VALUE_UNINSTALL_DISPLAY_VERSION, sizeof (VALUE_UNINSTALL_DISPLAY_VERSION));
			CHECK_PROPERTY (error, PROPERTY_UNINSTALL_DISPLAY_VERSION);

			CreatePropertyS32 (key, error, PROPERTY_UNINSTALL_ESTIMATED_SIZE, 10);
